window.onload = function () {
    ...
    var liArr = slide.getElementsByClassName("slide-li");
    ...
    var navLiArr = navUl.children;
    var UL = document.getElementsByClassName("nav-content-all")[0];
    var hiddenUl = document.getElementsByClassName("nav-all-ul")[0];
    UL.onmouseover = function () {
        UL.style.background = "#00B38A";
        hiddenUl.style.display = "block";
    }
    UL.onmouseout = function () {
        UL.style.background = "#27CBAB";
    ...
    for(var i=0;i<navLiArr.length;i++) {
        ...
        navLiArr[i].onmouseout = function () {
            for (var j = 0; j < navLiArr.length; j++) {
                navLiArr[j].className = "";
            }
        }
    ...
    //***ul-all部分
    var allUl = document.getElementById("all-ul");
    var allLiArr = allUl.children;
    for(var i=0;i<allLiArr.length;i++){
        allLiArr[i].onmouseover = function () {
            for(var j=0;j<allLiArr.length;j++){
                allLiArr[j].className = "all-li";
            }
            this.className = "li-current";
        }
        allLiArr[i].onmouseout = function () {
            for(var j=0;j<allLiArr.length;j++){
                allLiArr[j].className = "all-li";
            }
        }
